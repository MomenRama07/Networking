        ...
        while (currentTime < simulationDuration) {
            if (!readyQueue.isEmpty()) {
                ...
                currentTime += currentTask.wcet;
                 ...
                 if (currentTime - (currentTask.deadline - currentTask.period) > currentTask.wcet) {
                    System.out.println("Task " + currentTask.id + " exceeded WCET. Deactivating until next period.");
                }
                ...
                addTask(currentTask);
                 ...
                 System.out.println("Time " + currentTime + ": No tasks to execute. CPU idle.");
                currentTime++;
            }
        }
    }
